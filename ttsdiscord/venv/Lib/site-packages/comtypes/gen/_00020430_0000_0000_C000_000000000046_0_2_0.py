...
IFontDisp = Font
__all__ = [ 'OLE_XPOS_CONTAINER', 'Font', 'FONTITALIC',
           'FONTSTRIKETHROUGH', 'Color', 'Picture', 'IFont',
           'FONTUNDERSCORE', 'OLE_YPOS_HIMETRIC', 'OLE_YPOS_PIXELS',
           'IPictureDisp', 'Gray', 'IFontEventsDisp', 'StdPicture',
           'OLE_YSIZE_CONTAINER', 'OLE_YPOS_CONTAINER', 'Unchecked',
           'Default', 'VgaColor', 'OLE_YSIZE_PIXELS',
           'OLE_OPTEXCLUSIVE', 'OLE_HANDLE', 'OLE_ENABLEDEFAULTBOOL',
           'FONTSIZE', 'OLE_XPOS_PIXELS', 'OLE_COLOR',
           'OLE_XPOS_HIMETRIC', 'OLE_XSIZE_PIXELS', 'StdFont',
           'Checked', 'LoadPictureConstants', 'OLE_YSIZE_HIMETRIC',
           'FONTBOLD', 'OLE_CANCELBOOL', 'FONTNAME', 'FontEvents',
           'OLE_TRISTATE', 'OLE_XSIZE_CONTAINER', 'Monochrome',
           'OLE_XSIZE_HIMETRIC', 'IPicture', 'IFontDisp']
